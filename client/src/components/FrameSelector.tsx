...
const FRAME_OPTIONS: { id: FrameStyle; name: string; borderWidth: string; borderStyle: string }[] = [
  ...
  { id: 'gallery-brass', name: 'Gallery Brass', borderWidth: '9px', borderStyle: 'solid' },
  { id: 'matte-bronze', name: 'Matte Bronze', borderWidth: '9px', borderStyle: 'solid' },
  { id: 'ebonized-oak', name: 'Ebonized Oak', borderWidth: '11px', borderStyle: 'solid' },
  { id: 'weathered-black', name: 'Weathered Black', borderWidth: '8px', borderStyle: 'solid' },
  { id: 'museum-white', name: 'Museum White', borderWidth: '8px', borderStyle: 'solid' },
  { id: 'brushed-chrome', name: 'Brushed Chrome', borderWidth: '9px', borderStyle: 'solid' },
...
const FRAME_COLORS: Record<string, string> = {
  ...
  'gallery-brass': '#b08d57',
  'matte-bronze': '#8c6239',
  'ebonized-oak': '#2f241d',
  'weathered-black': '#3b3b3b',
  'museum-white': '#f2f2ee',
  'brushed-chrome': '#aeb4bc',
