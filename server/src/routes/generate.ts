...
function getFrameConfig(style: string) {
  const configs: Record<string, { width: number; color: string; shadow: boolean; double: boolean }> = {
    ...
    'gallery-brass': { width: 14, color: '#b08d57', shadow: true, double: false },
    'matte-bronze': { width: 14, color: '#8c6239', shadow: true, double: false },
    'ebonized-oak': { width: 18, color: '#2f241d', shadow: true, double: false },
    'weathered-black': { width: 12, color: '#3b3b3b', shadow: true, double: false },
    'museum-white': { width: 12, color: '#f2f2ee', shadow: true, double: false },
    'brushed-chrome': { width: 14, color: '#aeb4bc', shadow: true, double: false },
